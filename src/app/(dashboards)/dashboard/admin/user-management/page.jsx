...
const UserManagement = () => {
    ...
    const { data = [], isLoading, error , refetch } = useQuery({
        ...
        queryFn: () =>
          axios
            .get(`${process.env.NEXT_PUBLIC_BASE_URL}/dashboard/admin/user-management/api`)
            .then((res) => res.data),
      ...
      const handleDelete = (id) => {
        ...
        Swal.fire({
          ...
          axios.delete(`${process.env.NEXT_PUBLIC_BASE_URL}/dashboard/admin/user-management/api/${id}`)
          .then((res)=>{
      ...
      const handleModerator = (id) => {
        axios.patch(`${process.env.NEXT_PUBLIC_BASE_URL}/dashboard/admin/user-management/api/${id}`)
        .then((res)=>{
            if(res?.status === 200){
              refetch()
              Swal.fire({
